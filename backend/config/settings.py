...
#corsheader is needed to handle any error or issues that occur when using APIs for integration
#that violate CORS rules. Note this is Cross-Origin concept
INSTALLED_APPS = [
